...
"[project]/src/app/api/admin/admin-emails/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const [rows] = await pool.query("SELECT id, email, active, recovery_keyword, created_at FROM admin_emails ORDER BY created_at ASC");
...
async function POST(request) {
    try {
        ...
        await pool.query("INSERT INTO admin_emails (id, email, recovery_keyword, active) VALUES (?, ?, ?, 1)", [
            newId,
            normalizedEmail,
            normalizedKeyword.trim() ? normalizedKeyword : null
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b253d2e0._.js.map